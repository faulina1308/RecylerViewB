package com.faulinaindri202102297.recyclerviewb;
...
public class AddMahasiswaActivity extends AppCompatActivity {
    ...
    private EditText _tempatTanggallahirEditText;
    ...
    private void initSaveButton() {
        ...
        _saveButton.setOnClickListener(new View.OnClickListener(){
          ...
          public void onClick(View view){
                ...
                String tempatLahir = _tempatTanggallahirEditText.getText().toString();
    ...
    private void initInputs() {
        ...
        _tempatTanggallahirEditText = findViewById(R.id.tempatLahirEditText);
